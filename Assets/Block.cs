...
public class Block {
	...
	{
		Block[,,] chunks;
        //Test the coordinates for whether the neighbor is located outside of the Chunk. 
        //If the value is less than 0, it exists in another Chunk, or Greater than the World Size, means it is in another chunk
        if (x < 0 || x>= World.chunkSize ||
            y < 0 || y>= World.chunkSize ||
            z < 0 || z>= World.chunkSize)
        {
            //This searches for the position of the nearest Neighbour.  
            ...
            //This gathers the Nearest Neighbors ID
            ...
            //Return the Value of the Neighbours index
    ...
    {
        //A simple function that tests for the value of a coordinate in Chunk size and converts it to a value located within the index of it's nearest Neighbour.
        if (i == -1)
        {
            i = World.chunkSize - 1;
        }
